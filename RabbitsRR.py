...
# contain the rabbits that were alive the previous month, plus any 
# new offspring. A key observation is that the number of offspring 
# in any month is equal to the number of rabbits that were alive two 
# months prior. As a result, if Fn represents the number of rabbit pairs 
...
# Fibonacci's name, it was known to Indian mathematicians over two millennia 
# ago.
...
k = int(input("How many pairs per offspring? "))
